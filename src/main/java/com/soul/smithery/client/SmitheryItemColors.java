...
public final class SmitheryItemColors {
    ...
    public static void onRegisterItemColors(RegisterColorHandlersEvent.Item event) {
        ...
        List<Item> composedItems = composedGear();
    ...
    /**
     * Every composed-gear item (tools, ranged, armor) sharing the slot-indexed tint handler
     * and the emissive model wrapper. Single source of truth for both registrations.
     */
    public static List<Item> composedGear() {
        return List.of(
                ...
                SmitheryItems.MINING_HAMMER.get(), SmitheryItems.KAMA.get(), SmitheryItems.SCYTHE.get(),
                SmitheryItems.SCEPTRE.get(), SmitheryItems.CLEAVER.get(),
    ...
    /**
     * Part items: layer 0 takes the part's material color — animated via
     * {@link MaterialColorAnimator} when the material declares a color cycle.
     */
